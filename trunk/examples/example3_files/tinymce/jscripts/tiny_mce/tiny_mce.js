...
/*			if (elm == inst.lastTriggerEl)
	...
	openWindow : function(template, args) {
		...
		alert('aa');
			...
			win = window.open("", "mcePopup" + new Date().getTime(), "top=" + y + ",left=" + x + ",scrollbars=" + scrollbars + ",dialog=yes,minimizable=" + resizable + ",status = yes ,width=" + width + ",height=" + height + ",resizable=" + resizable);
			if (win == null) {
			...
			//alert('cc');
				...
				//win = window.open(url, "mcePopup" + new Date().getTime(), "status=yes;top=" + y + ",left=" + x + ",scrollbars=" + scrollbars + ",dialog=" + modal + ",minimizable=" + resizable + ",modal=" + modal + ",width=" + width + ",height=" + height + ",resizable=" + resizable);
				win = window.open(url);
				if (win == null) {
					alert(tinyMCELang.lang_popup_blocked);
					return;
