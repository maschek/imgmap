...
/**
	This will work only in Opera and in Firefox with Firebug installed
	It outputs any object or message to the error console instead of opening a new window 
*/
FCKDebug.OutputInConsole = function( anyObject )
{
	if ( typeof(console) == 'object' && console.debug )
	{
		console.debug( anyObject ) ;
	}
	if ( typeof(opera) == 'object' && opera.postError )
	{
		opera.postError( anyObject ) ;
	}

	this.Output(anyObject) ;
}